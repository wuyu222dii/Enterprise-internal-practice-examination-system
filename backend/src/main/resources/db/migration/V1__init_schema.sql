...
CREATE TABLE exams (
    ...
    open_start_at   TIMESTAMPTZ,
    stop_attempt_at TIMESTAMPTZ,
...
CREATE UNIQUE INDEX idx_exam_attempt_in_progress
    ON exam_attempts (exam_id, employee_id)
    WHERE attempt_status IN ('inProgress', 'submitting');
...
CREATE TABLE outage_events (
    ...
    open_interval_end TIMESTAMPTZ,
    affected_exam_ids JSONB NOT NULL DEFAULT '[]',
